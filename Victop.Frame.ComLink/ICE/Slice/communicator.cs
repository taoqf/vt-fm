...
namespace slice
{
    ...
    public sealed class MessageEndpointPrxHelper : Ice.ObjectPrxHelperBase, MessageEndpointPrx
    {
        ...
        {
            return sendMessage(hash, isAsync, msg, index, fragmentSize, messagecontent, null, false);
        }
        ...
        {
            return sendMessage(hash, isAsync, msg, index, fragmentSize, messagecontent, context__, true);
        }

        private slice.Reply sendMessage(string hash, bool isAsync, slice.Message msg, int index, int fragmentSize, string messagecontent, _System.Collections.Generic.Dictionary<string, string> context__, bool explicitContext__)
        {
            if(explicitContext__ && context__ == null)
            {
                context__ = emptyContext_;
            }
            Ice.Instrumentation.InvocationObserver observer__ = IceInternal.ObserverHelper.get(this, __sendMessage_name, context__);
            int cnt__ = 0;
            try
            {
                while(true)
                {
                    ...
                    try
                    {
                        ...
                        delBase__ = getDelegate__(false);
                        MessageEndpointDel_ del__ = (MessageEndpointDel_)delBase__;
                        return del__.sendMessage(hash, isAsync, msg, index, fragmentSize, messagecontent, context__, observer__);
                    }
                    catch(IceInternal.LocalExceptionWrapper ex__)
                    {
        ...
        {
            return begin_sendMessage(hash, isAsync, msg, index, fragmentSize, messagecontent, null, false, null, null);
        }
        ...
        {
            return begin_sendMessage(hash, isAsync, msg, index, fragmentSize, messagecontent, ctx__, true, null, null);
        }
        ...
        {
            return begin_sendMessage(hash, isAsync, msg, index, fragmentSize, messagecontent, null, false, cb__, cookie__);
        }
        ...
        {
            return begin_sendMessage(hash, isAsync, msg, index, fragmentSize, messagecontent, ctx__, true, cb__, cookie__);
        }
        ...
        private Ice.AsyncResult<slice.Callback_MessageEndpoint_sendMessage> begin_sendMessage(string hash, bool isAsync, slice.Message msg, int index, int fragmentSize, string messagecontent, _System.Collections.Generic.Dictionary<string, string> ctx__, bool explicitContext__, Ice.AsyncCallback cb__, object cookie__)
        {
...
namespace slice
{
    ...
    {
        slice.Reply sendMessage(string hash, bool isAsync, slice.Message msg, int index, int fragmentSize, string messagecontent, _System.Collections.Generic.Dictionary<string, string> context__, Ice.Instrumentation.InvocationObserver observer__);
    }
}
...
namespace slice
{
    ...
    public sealed class MessageEndpointDelM_ : Ice.ObjectDelM_, MessageEndpointDel_
    {
        ...
        public slice.Reply sendMessage(string hash, bool isAsync, slice.Message msg, int index, int fragmentSize, string messagecontent, _System.Collections.Generic.Dictionary<string, string> context__, Ice.Instrumentation.InvocationObserver observer__)
        {
            IceInternal.Outgoing og__ = handler__.getOutgoing("sendMessage", Ice.OperationMode.Idempotent, context__, observer__);
            try
            {
                try
                {
