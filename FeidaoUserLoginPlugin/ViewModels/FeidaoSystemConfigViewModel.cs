...
{
    public class FeidaoSystemConfigViewModel : ModelBase
    {
        #region 字段
        private FeidaoSystemConfigModel sysConfigModel;
        ...
        public FeidaoSystemConfigModel SysConfigModel
        {
            get
            {
                if (sysConfigModel == null)
                    sysConfigModel = new FeidaoSystemConfigModel();
        ...
        public ICommand btnSystemCancelClickCommand
        {
            get
            {
                return new RelayCommand(() =>
