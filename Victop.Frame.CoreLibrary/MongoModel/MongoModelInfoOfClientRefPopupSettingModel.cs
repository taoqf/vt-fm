...
namespace Victop.Frame.CoreLibrary.MongoModel
{
    ...
    public class MongoModelInfoOfClientRefPopupSettingModel
    {
        ...
        /// 装配列信息
        /// </summary>
        private List<MongoModelInfoOfClientRefPopupSettingColumnsModel> settingColumns;
        [JsonProperty(PropertyName = "columns")]
        public List<MongoModelInfoOfClientRefPopupSettingColumnsModel> SettingColumns
        {
            get
            {
                if (settingColumns == null)
                    settingColumns = new List<MongoModelInfoOfClientRefPopupSettingColumnsModel>();
